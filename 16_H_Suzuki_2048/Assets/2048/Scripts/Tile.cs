...
public class Tile : MonoBehaviour {
	...
	void Update () {
		...
		textFab.GetComponent<TextMeshProUGUI>().transform.position = Camera.main.WorldToViewportPoint (transform.position);
	...
	void Change (int newValue) {
		...
		textFab.GetComponent<TextMeshProUGUI>().text = tileValue.ToString();
		// colour value which is written on our cell
		textFab.GetComponent<TextMeshProUGUI>().color = new Color (0.17f, 0.17f, 0.27f);
	}
