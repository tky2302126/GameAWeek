...
public class Manager : MonoBehaviour {
	...
	void Start () {
		...
		highScoreText.GetComponent<TextMeshProUGUI>().text = "Best score : " + highscore;
	...
	void Update () {
        ...
        if(winner) {
			...
			youWonText.GetComponent<TextMeshProUGUI>().text = "Well done!"; // text
			// save the high score
			if(score > highscore) {
				highscore = score;
		...
		if(gameOver) {
			...
			youLoseText.GetComponent<TextMeshProUGUI>().text = "Game Over"; // text
			// save the high score
			if(score > highscore) {
				highscore = score;
				PlayerPrefs.SetInt("High Score", highscore);
